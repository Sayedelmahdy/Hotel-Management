...
namespace Hotel_Manager
{
    public partial class Login : Form
    {
        ...
        private void signinButton_Click(object sender, EventArgs e)
        {
            try
            {
                if (verifier("frontend".Trim(), usernameTextBox.Text.Trim(), passwordTextBox.Text.Trim()))//true login front
                {
                ...
                else if (verifier("kitchen".Trim(), usernameTextBox.Text.Trim(), passwordTextBox.Text.Trim()))//true login kitchen
                {
                    this.Hide();
                    Kitchen kitchen_management = new Kitchen(context);
                    kitchen_management.Show();
                }
                else //false login both
                {
